...
export default class Artical extends Component {
  ...
  createColums = (columnsKey) => {
    const colums = columnsKey.map((item) => {
      if (item === "amount") {
        return {
        ...
        return (
          <ButtonGroup>
            <Button
              ...
              type="primary"
              onClick={() => {
                this.props.history.push("/admin/artical/edit");
              }}
            >
              编辑
            </Button>
            <Button
              size="small"
              type="danger"
              onClick={this.showDeleteArtical.bind(this, record)}
            >
              删除
            </Button>
          </ButtonGroup>
  ...
  deleteArtical() {
    ...
    // })
    deleteArticalsById(this.state.deleteArticalId)
      .then((resp) => {
